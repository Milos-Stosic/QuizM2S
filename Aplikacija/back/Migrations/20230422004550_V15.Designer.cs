...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Quiz", b =>
                {
                    ...
                    b.Property<int?>("UsersPlayedQuizzesID")
                        .HasColumnType("int");

                    b.Property<int?>("UsersPlayedUsersID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UsersPlayedQuizzesID", "UsersPlayedUsersID");
            ...
            modelBuilder.Entity("Models.Users", b =>
                {
                    ...
                    b.Property<int?>("QuizzesDoneQuizzesID")
                        .HasColumnType("int");

                    b.Property<int?>("QuizzesDoneUsersID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QuizzesDoneQuizzesID", "QuizzesDoneUsersID");
            ...
            modelBuilder.Entity("Models.Quiz", b =>
                {
                    ...
                    b.HasOne("Models.QuizUser", "UsersPlayed")
                        .WithMany("Quiz")
                        .HasForeignKey("UsersPlayedQuizzesID", "UsersPlayedUsersID");
            ...
            modelBuilder.Entity("Models.Users", b =>
                {
                    b.HasOne("Models.QuizUser", "QuizzesDone")
                        .WithMany("User")
                        .HasForeignKey("QuizzesDoneQuizzesID", "QuizzesDoneUsersID");
